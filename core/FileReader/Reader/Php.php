...
class Php extends AbstractType
{
    protected function loadFile()
    {
        ...
        try {
            ...
            \ModulesGarden\Servers\ZimbraEmail\Core\ServiceLocator::call("errorManager")->addError("ModulesGarden\\Servers\\ZimbraEmail\\Core\\FileReader\\Reader\\Php", $e->getMessage(), $e->getTrace());
            $this->data = $return;
        }
    }
}
