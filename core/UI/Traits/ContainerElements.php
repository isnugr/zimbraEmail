...
interface ContainerElements
{
     ...
     */
    protected $elements = [];
    public function addElement($element, $containerName);
    protected function prepareElementInstance($element);
    protected function checkElementItemContext();
    protected function addElementToContainer($element, $containerName);
    protected function registerMainContainerAdditions($element);
    public function getElementContainerName($containerName);
    public function addNewElementsContainer($containerName);
    public function getElements($containerName);
    public function elementsExists($containerName);
    public function getElementById($id, $containerName);
    public function insertElementById($id, $containerName);
    public function getElementsContainers();
    public function elementContainerExists($containerName);
}
