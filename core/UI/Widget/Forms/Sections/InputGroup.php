...
{
    use \ModulesGarden\Servers\ZimbraEmail\Core\UI\Traits\Description;
    ...
    public function addTextField($initName, $placecholder = false, $notEmpty = true, \ModulesGarden\Servers\ZimbraEmail\Core\UI\Widget\Forms\Validators\BaseValidator $validator = NULL)
    {
        $newTextField = new \ModulesGarden\Servers\ZimbraEmail\Core\UI\Widget\Forms\Fields\InputGroupElements\Text($initName);
    ...
    {
        $newAddonField = new \ModulesGarden\Servers\ZimbraEmail\Core\UI\Widget\Forms\Fields\InputGroupElements\InputAddon();
