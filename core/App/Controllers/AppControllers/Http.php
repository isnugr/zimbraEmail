...
class Http extends \ModulesGarden\Servers\ZimbraEmail\Core\App\Controllers\AppController implements \ModulesGarden\Servers\ZimbraEmail\Core\App\Controllers\Interfaces\AppController
{
    public function getControllerInstanceClass($callerName, $params)
    {
        ...
        switch ($functionName) {
            case "output":
                return "ModulesGarden\\Servers\\ZimbraEmail\\Core\\App\\Controllers\\Instances\\Http\\AdminPageController";
                break;
            case "clientarea":
                return "ModulesGarden\\Servers\\ZimbraEmail\\Core\\App\\Controllers\\Instances\\Http\\ClientPageController";
                break;
        }
    }
