 ...
 */
class HostingConfigOption extends \Illuminate\Database\Eloquent\Model
{
    /**
     * Table name
     *
    ...
    {
        return $this->belongsTo("ModulesGarden\\Servers\\ZimbraEmail\\Core\\Models\\Whmcs\\ProductConfigOptionSub", "optionid");
    }
}
