...
function tldCategoriesSortableController()
{
    ...
    if (! $('#groupList.vSortable').hasClass('ui-sortable'))
    {
        $("#groupList.vSortable").sortable(
        {
            ...
            stop: function(event, ui)
            {
                ...
                mgPageControler.vueLoader.updateSorting(order, 'addCategoryForm', 'ModulesGarden_ZimbraEmail_App_UI_Widget_DoeTldConfigComponents_CategoryForms_AddCategoryForm');
    ...
    $('#itemContentContainer tbody.vSortable').sortable(
    {
        stop: function(event, ui)
        {
            ...
            mgPageControler.vueLoader.updateSorting(order, 'assignTldForm', 'ModulesGarden_ZimbraEmail_App_UI_Widget_DoeTldConfigComponents_CategoryForms_AssignTldForm');
        },
