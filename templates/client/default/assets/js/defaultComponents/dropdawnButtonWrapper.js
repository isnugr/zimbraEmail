mgJsComponentHandler.addDefaultComponent('mg-dropdawn-btn-wrapper', {
    ...
    methods: {
        ...
        loadModal: function(event, targetId, namespace, index){
            var ns = typeof namespace !== 'undefined' ? namespace : getItemNamespace(targetId);
            var idx =  typeof index !== 'undefined' ? index : getItemIndex(targetId);
            mgPageControler.vueLoader.loadModal(event, targetId, ns, idx, {}, true);
        },
