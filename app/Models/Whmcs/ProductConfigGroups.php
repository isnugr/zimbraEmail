 ...
 */
class ProductConfigGroups extends \Illuminate\Database\Eloquent\model
{
    /**
     * Table name
     *
    ...
    {
        return $this->hasMany("ModulesGarden\\Servers\\ZimbraEmail\\Core\\Models\\Whmcs\\ProductConfigOption", "gid", "id");
    }
}
