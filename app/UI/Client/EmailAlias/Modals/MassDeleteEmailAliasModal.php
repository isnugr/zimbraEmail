...
class MassDeleteEmailAliasModal extends \ModulesGarden\Servers\ZimbraEmail\Core\UI\Widget\Modals\BaseModal implements \ModulesGarden\Servers\ZimbraEmail\Core\UI\Interfaces\ClientArea
{
    ...
    public function initContent()
    {
        ...
        $this->addForm(new \ModulesGarden\Servers\ZimbraEmail\App\UI\Client\EmailAlias\Forms\MassDeleteEmailAliasForm());
    }
}
